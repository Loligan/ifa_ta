...
class UserDocumentsAddNewPorPageObject extends PageObject
{
    const PATH_REGEX = '/(\/documents\/create-proof-of-residence$)/';
    const SUBTYPE_SELECT = './/select[@id="proof_of_address_form_subtype"]';
    const SUBTYPE_OPTION = './/select[@id="proof_of_address_form_subtype"]/option[text()="VALUE"]';
    const FILE_INPUT = './/*[@id="proof_of_address_form_file"]';
