@my @profile
Feature: MY - Create profile in CRM and check data in MY
  ...
  @positive
  Scenario Outline: Create profile in CRM and check data in MY
    ...
    Then Open Login page == MY path: /login ==
    ...
    Examples:
      ...
      | Mitch                       | Lucker                      | Test address                | Test city                   | Belarus                  | BLR           | 04     | 02       | 1991   |
      | Mitch                       | Lucker                      | Test address                | Test city                   | Canada | CAN            | 15    | 12      | 1912   |
      | A                           | A                           | A                           | A                           | Canada | CAN            | 04     | 02       | 1991   |
      | 1                           | 1                           | 1                           | 1                           | Canada | CAN            | 04     | 02       | 1991   |
      | עברי                        | עברי                        | עברי                        | עברי                        | Canada | CAN            | 04     | 02       | 1991   |
      | Тест                        | Тест                        | Тест                        | Тест                        | Canada | CAN            | 04     | 02       | 1991   |
      | 中国                          | 中国                          | 中国                          | 中国                          | Canada | CAN            | 04     | 02       | 1991   |
      | null                        | null                        | null                        | null                        | Canada | CAN            | 04     | 02       | 1991   |
      | #@!$%&*(*)_#@               | #@!$%&*(*)_#@               | #@!$%&*(*)_#@               | #@!$%&*(*)_#@               | Canada | CAN            | 04     | 02       | 1991   |
      | %%%/%%%                     | %%%/%%%                     | %%%/%%%                     | %%%/%%%                     | Canada | CAN            | 04     | 02       | 1991   |
      | “♣☺♂” “”‘~~/\,.?></b,./\<][ | “♣☺♂” “”‘~~/\,.?></b,./\<][ | “♣☺♂” “”‘~~/\,.?></b,./\<][ | “♣☺♂” “”‘~~/\,.?></b,./\<][ | Canada | CAN            | 04     | 02       | 1991   |
      | Aa!@#$%^&*()                | Aa!@#$%^&*()                | Aa!@#$%^&*()                | Aa!@#$%^&*()                | Canada | CAN            | 04     | 02       | 1991   |
      | SHOW TABLES                 | SHOW TABLES                 | SHOW TABLES                 | SHOW TABLES                 | Canada | CAN            | 04     | 02       | 1991   |